...
export interface ApiCache {
   ...
   */
  delete(key: string): { type: 'success' } | { type: 'error'; code: string }
   ...
   */
  get(key: string): { value: string; expires_at: number } | undefined
  ...
  set(
    ...
    | {
        type: 'success'
        record: { value: string; expires_at: number }
      }
    | Error
}
