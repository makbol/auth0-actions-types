...
export interface ApiSAMLResponse {
   ...
   * @throws {Error} Failed operation throws an Error. For errors, the returned object has a message that indicates the nature of the failure.
   */
  setAttribute(
    attribute: string,
   ...
   * @param issuer The SAML issuer to be set.
   */
   ...
   * @param relayState RelayState of the SAML response.
   */
